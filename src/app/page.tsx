            ...
            <main>
                <div className="relative">
                            ...
                            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
                                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                                    <div className="hidden sm:mb-10 sm:flex">
                                        <div
                                            className="relative rounded-full px-3 py-1 text-sm leading-6 text-LightBlueAccent ring-2 ring-LightBrownAccent hover:ring-DarkBlueShade/80">
                                    ...
                                    <p className="mt-6 text-lg leading-8 text-DarkBrownShade">
                                        Welcome to Grime Guard Janitorial Services, your new reliable partner for all
                                        your commercial cleaning needs. <br/> <br/>We carry with us two decades of
                                        industry experience and an unwavering commitment to guard your space against
                                        grime, leaving nothing behind but a fresh, vibrant environment. </p>
                    ...
                    <div className="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                        <Image
                            className="aspect-[3/2] sm:object-cover md:object-right-top md ring-4 ring-LightBrownAccent/40  lg:aspect-auto lg:h-full lg:w-full"
                            src="/content/Grime-Guard-Janitorial-Services-Cleaning-Window-Denver-CO.png"
                            alt="Grime Guard Janitorial Services - Cleaning Window in Denver, CO"
                            height={1920}
                            width={1080}
                        />
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            <h2 className="text-3xl font-bold tracking-tight text-DarkBlueShade sm:text-4xl">
                                At Grime Guard, we tailor our services to meet your specific needs, fostering a clean,
                                comfortable, and productive work environment.
                            </h2>
                            <p className="mt-6 text-lg leading-8 text-DarkBrownShade">
                                Embark on your journey with Grime Guard today. Our straightforward process ensures that
                                your commercial space not only shines but also facilitates productivity, leaving you to
                                concentrate on what truly matters in your business.
                            </p>
                        </div>
                                ...
                                {services.map((service) => (
                                    <div key={service.name} className="flex flex-col">
                                        <dt className="text-base font-semibold leading-7 text-DarkBlueShade">
                                            <div
                                                className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-DarkBlueShade">
                    ...
                    <div
                        ...
                        <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                            <div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                                <Image
                                    className="absolute inset-0 h-full w-full rounded-2xl ring-4 ring-LightBrownAccent/90 bg-gray-800 object-cover md:object-cover object-top shadow-2xl"
                        ...
                        <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                            <figure className="relative isolate pt-6 sm:pt-12">
                                ...
                                <blockquote
                                    ...
                                    <p>
                                        At Grime Guard, we are committed to delivering a clean, safe, and hygienic
                                        workspace for our clients.<br/><br/> We understand the crucial role cleanliness
                                        plays in enhancing productivity and elevating brand reputation.<br/><br/> Our
                                        promise is to help you make the best impression every day.
                                    </p>
                                </blockquote>
                            ...
                            <div className="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
                                <div>
                                    ...
                                    <p className="mt-4 text-DarkBrownShade">
                                        Choosing Grime Guard means choosing a dedicated ally who will value and respect
                                        your space as much as you do.<br/><br/> We take immense pride in our attention
                                        to detail, professional demeanor, and the relentless pursuit of customer
                                        satisfaction.
                                    </p>
                                </div>
                                <div
                                    className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg bg-gray-100  ring-8 ring-LightBrownAccent/80">
                                    <Image
                                ...
                                {incentives.map((incentive) => (
                                    <div key={incentive.name} className="sm:flex lg:block">
                                        <div className="sm:flex-shrink-0">
                                            <incentive.icon className="h-12 w-auto flex-none text-DarkBlueShade"
                                                            aria-hidden="true"/>
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
                        <div
                            ...
                            <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                                <h2 className="text-3xl font-bold tracking-tight text-DarkBlueShade sm:text-4xl">Our
                                    people</h2>
                                <p className="mt-6 text-xl leading-8 text-DarkBrownShade">
                                    At the core of Grime Guard is our dedicated team, small but mighty, led by a
                                    seasoned professional with 20 years of industry experience. <br/><br/>Our people are
                                    more than our strength - they are our defining factor. </p>
                                <p className="mt-6 text-base leading-7 text-DarkBrownShade">
                                    Choosing Grime Guard means choosing a small business that operates with the passion,
                                    dedication, and personal touch that larger firms often lack. <br/><br/> You&apos;re
                                    not just hiring a cleaning service – you&apos;re partnering with a team that brings
                                    a wealth of industry knowledge and skill to your commercial space.
                                </p>
                            </div>
                            <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                                <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                                    <Image
                                        src="/content/Grime-Guard-Janitorial-Services-Cleaning-Table-Denver-CO.png"
                                        height={1920}
                                        width={1080}
                ...
                <div className="bg-DarkBlueShade py-24 sm:py-32">
                    <div className="relative isolate">
                        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                            <div
                                className="mx-auto flex max-w-2xl flex-col gap-16 bg-LightBrownAccent/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-2xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
                                <Image
                                ...
                                <div className="w-full flex-auto">
                                    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">The Grime
                                        Guard Difference</h2>
                                    <p className="mt-6 text-lg leading-8 text-gray-300">
                                        Our team is led by a seasoned professional with 20 years of industry experience,
                                        ensuring high-quality service that meets and exceeds your expectations. </p>
                                    <ul
                                        role="list"
                ...
                <div className="relative bg-DarkBlueShade">
                    <div
                        className="relative h-80 overflow-hidden rounded-t-2xl md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2 ring-8 ring-LightBrownAccent/80">
                        <Image
                    ...
                    <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
                        <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                            <h2 className="text-base font-semibold leading-7 text-LightBrownAccent">Diligence &
                                Timeliness</h2>
                            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Without
                                compromising on service quality</p>
                            <p className="mt-6 text-base leading-7 text-gray-300">
                                In the world of janitorial services, punctuality and diligence are of utmost
                                importance. <br/><br/> At Grime Guard, we respect your time and always ensure our
                                cleaning tasks are completed within the agreed timeframe.</p>
                            {/*<div className="mt-8">*/}
                            {/*    <a*/}
                            {/*        href="#"*/}
                ...
                <div
                        ...
                        <div
                            ...
                            <div className="lg:pr-4">
                                <div className="lg:max-w-lg">
                                    <p className="text-base font-semibold leading-7 text-LightBlueAccent">Accommodating
                                        Your Schedule</p>
                                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-DarkBlueShade sm:text-4xl">Streamlined
                                        Process, Optimized Results</h1>
                                    <p className="mt-6 text-xl leading-8 text-DarkBrownShade">
                        ...
                        <div
                            ...
                            <div className="lg:pr-4">
                                <div className="max-w-xl text-base leading-7 text-DarkBrownShade lg:max-w-lg">
                                    <p>
                                        At Grime Guard, we understand the importance of a clean work environment, as
                                        well as the value of your time.<br/><br/> That&apos;s why we&apos;ve designed a
                                        flexible, efficient workflow that aligns with your schedule and operational
                                        needs.
                                    </p>
                                    <ul role="list" className="mt-8 space-y-8 text-DarkBrownShade">
                                        <li className="flex gap-x-3">
                                            <PhoneIcon className="mt-1 h-5 w-5 flex-none text-DarkBlueShade"
                                                       aria-hidden="true"/>
                                            <span>
                    <strong className="font-semibold text-DarkBlueShade">Consultation</strong> Our process begins with a detailed understanding of your cleaning needs and scheduling requirements.
                                        ...
                                        <li className="flex gap-x-3">
                                            <ClockIcon className="mt-1 h-5 w-5 flex-none text-DarkBlueShade"
                                                       aria-hidden="true"/>
                                            <span>
                    <strong className="font-semibold text-DarkBlueShade">Scheduling</strong> Based on your business hours and preferences, we arrange our cleaning services to minimize disruption to your operations.
                                        ...
                                        <li className="flex gap-x-3">
                                            <BuildingOfficeIcon className="mt-1 h-5 w-5 flex-none text-DarkBlueShade"
                                                                aria-hidden="true"/>
                                            <span>
                    <strong className="font-semibold text-DarkBlueShade">Clean as Scheduled</strong> Our team arrives as scheduled, performing the cleaning tasks diligently and efficiently, while respecting your workspace.
                                    ...
                                    <p className="mt-8">
                                        This process ensures that our cleaning services not only meet the high-quality
                                        standards we uphold at Grime Guard but also seamlessly fit into your daily
                                        routine, enhancing your work environment without any disruptions.
                                    </p>
                                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-DarkBlueShade">Committed
                                        to Your Satisfaction</h2>
                                    <p className="mt-6">
                                        At Grime Guard, your satisfaction is our priority. We continually strive to
                                        refine our workflow and services based on your feedback and evolving
                                        needs. <br/><br/> With our flexible scheduling and commitment to excellence, we
                                        aim to provide a service that surpasses your expectations while respecting your
                ...
                <div className="bg-white py-24 sm:py-32">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div
                            ...
                            <div className="lg:pr-4">
                                <div
                                    className="relative overflow-hidden rounded-3xl bg-LightBrownAccent px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                                    <Image
                                    ...
                                    <figure className="relative isolate">
                                        <Image src="/Grime Guard Logo.png" alt="Image by Freepik"
                                               className="h-20 w-auto bg-LightBrownAccent/80" height={1920}
                                               width={1080}/>
                                        <blockquote
                                            className="mt-2 text-xl font-semibold leading-10 text-DarkBlueShade bg-LightBrownAccent/80">
                                            <p>
                                                Perfecting cleanliness with passion in Lakewood and across the vibrant
                                                neighboring communities of Colorado&apos;s Front Range.
                                            </p>
                                        </blockquote>
                                        <figcaption
                                            className="mt-6 text-sm leading-6 text-DarkBlueShade bg-LightBrownAccent/80">
                                            <strong className="font-semibold text-DarkBlueShade">Locally Owned,
                                                Community Focused </strong> | Choose local. Choose Grime Guard.
                                        </figcaption>
                                    </figure>
                                </div>
                            </div>
                            <div>
                                <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
                                    <p className="text-base font-semibold leading-7 text-LightBlueAccent">Proudly
                                        Serving Colorado&apos;s Front Range</p>
                                    ...
                                    <div className="max-w-xl">
                                        <p className="mt-6 text-DarkBrownShade">
                                            Grime Guard is more than just a janitorial service; we&apos;re your
                                            neighbors. Proudly based in the vibrant city of Lakewood, we are
                                            well-positioned to serve businesses across the Colorado Front Range and
                                            within a 60-mile radius of our hometown.
                                        </p>
                                        <p className="mt-8 text-DarkBrownShade">
                                            From the bustling heart of Denver to the scenic city of Boulder, the
                                            historic charm of Golden to the dynamic cityscape of Aurora, we are here to
                                            serve you.
                                        </p>
                                        <p className="mt-8 text-DarkBrownShade">
                                            Our Colorado roots run deep, and our love for this region fuels our
                                            commitment to delivering top-tier janitorial services. We&apos;re excited to
                                            bring our professional, reliable, and affordable cleaning services to more
                                            businesses around the Centennial State.
                                        </p>
                                        <p className="mt-8 text-DarkBrownShade">
                ...
                <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
                    ...
                    />
                    <div
                        className="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl bg-LightBrownAccent/40">
                        <div
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            <h2 className="text-4xl font-bold tracking-tight text-DarkBlueShade sm:text-6xl bg-LightBrownAccent/40 rounded-2xl">Your
                                Partner in Cleanliness</h2>
                            <p className="mt-6 text-lg leading-8 text-gray-300 p-6 ring-inset ring-LightBrownAccent/80 ring-1 bg-DarkBlueShade/80 rounded-xl ">
                                As your trusted partner, Grime Guard upholds the cleanliness and hygiene of your
                                workspace, providing high-quality, personalized janitorial services. With two decades of
                                experience in the industry, we have honed our skills and refined our processes to ensure
                        ...
                        <div
                            ...
                            {cards.map((card) => (
                                <div key={card.name}
                                     className="flex gap-x-4 rounded-xl bg-DarkBlueShade/80 p-6 ring-1 ring-inset ring-LightBrownAccent/80">
                ...
                <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                    ...
                    <div className="mx-auto max-w-xl lg:max-w-4xl">
                        <h2 className="text-4xl font-bold tracking-tight text-DarkBlueShade">Sign Up for a Quote
                            Today</h2>
                        <p className="mt-2 text-lg leading-8 text-DarkBrownShade">Transform Your Workspace With Grime
                            Guard</p>
                                ...
                                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                    <div>
                                        <label htmlFor="first-name"
                                               className="block text-sm font-semibold leading-6 text-DarkBlueShade">
                                            First name
                                        </label>
                            ...
                            <div className="lg:mt-6 lg:w-80 lg:flex-none">
                                ...
                                <figure className="mt-10">
                                    <blockquote className="text-lg font-semibold leading-8 text-DarkBlueShade">
                                        <p>
                                            Don&apos;t wait for grime to take over. Schedule a consultation with Grime
                                            Guard today and reclaim your clean, productive workspace. Fill out the form
                                            to begin your cleanliness journey. </p>
                                    </blockquote>
                                </figure>
                            </div>
                        </div>
